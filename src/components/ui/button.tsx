...
const buttonVariants = cva(
	'active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-background focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-background disabled:pointer-events-none dark:focus:ring-offset-foreground',
	{
		variants: {
			variant: {
