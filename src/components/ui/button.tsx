...
const buttonVariants = cva(
	'active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-slate-400 disabled:pointer-events-none dark:focus:ring-offset-slate-900',
	{
		variants: {
			variant: {
				default: 'bg-foreground text-background-100 hover:bg-foreground',
				destructive:
					'bg-destructive text-destructive-foreground hover:bg-destructive/90',
				outline:
					'bg-background-100 text-foreground hover:bg-background outline outline-1 outline-background',
				subtle: 'hover:bg-background bg-background-100 text-foreground',
				ghost:
					'bg-transparent hover:bg-background-100 text-foreground data-[state=open]:bg-transparent data-[state=open]:bg-transparent',
				transparent:
