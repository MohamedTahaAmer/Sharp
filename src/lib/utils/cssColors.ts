export function colorNameToHex(colorName: string): string {
	// Define a mapping of CSS color names to hex values
	...
	// Check if the input color name exists in the mapping
	if (lowerColorName in colorMap) {
		return colorMap[lowerColorName];
	} else {
		return colorName; // Return null if the color name is not found
	}
}
